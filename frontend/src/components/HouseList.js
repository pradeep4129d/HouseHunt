  ...
  const fetchHouses = async () => {
    try {
      ...
      const response = await axios.get(
        `http://localhost:5000/api/houses?${queryParams}`,
        {
          headers: {
              ...
              <div className="card h-100 house-card">
                ...
                <div className="card-body">
                  ...
                  <div className="house-features">
                    <span>
                      <i className="bi bi-door-closed"></i> {house.bedrooms} Beds
                    </span>
                    <span>
                      <i className="bi bi-droplet"></i> {house.bathrooms} Baths
                    </span>
                    <span>
                      <i className="bi bi-rulers"></i> {house.squareFeet} sq ft
                    </span>
                  </div>
                </div>
              </div>
